...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	if ($id_anggota <= 0 || $no_tlp === '') {
		$error = 'ID Anggota dan No Telepon harus diisi!';
	} else {
		...
		$error = 'Data login anggota tidak cocok!';
	}
}
?>
<!DOCTYPE html>
...
<head>
	...
	<style>
		...
		* { box-sizing: border-box; margin: 0; padding: 0; }
		...
		.login-body { padding: 42px 36px; background: rgba(255,255,255,0.95); }
...
<body>
	<div class="login-container">
		<div class="login-header">
			...
			<p>
				Akses khusus anggota koperasi untuk melihat riwayat simpanan,
				pinjaman, angsuran, serta mengajukan pinjaman baru.
			</p>
		</div>
		...
		<div class="login-body">
			...
			<h2 class="mb-2" style="font-weight: 800; color: #0f172a;">Login Anggota</h2>
			<p class="mb-4" style="color: #64748b;">Masukkan ID anggota dan nomor telepon yang terdaftar.</p>

			<form method="POST" action="">
				<div class="form-group">
					<label for="id_anggota"><i class="fas fa-hashtag"></i> ID Anggota</label>
					<input type="number" id="id_anggota" name="id_anggota" min="1" placeholder="Contoh: 1" required>
				</div>
			...
			<div class="login-note">
				...
				Gunakan data anggota yang sudah terdaftar di sistem koperasi.
			</div>

			<div class="login-links">
				<a href="<?php echo BASE_URL; ?>/login.php" class="link-petugas">
